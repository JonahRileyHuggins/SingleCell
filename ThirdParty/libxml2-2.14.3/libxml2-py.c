...
libxml_htmlCtxtSetOptions(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Oi:htmlCtxtSetOptions", &pyobj_ctxt, &options))
        return(NULL);
...
libxml_htmlReadDoc(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"zzzi:htmlReadDoc", &str, &url, &encoding, &options))
        return(NULL);

    c_retval = htmlReadDoc(str, url, encoding, options);
    py_retval = libxml_xmlDocPtrWrap((xmlDocPtr) c_retval);
    return(py_retval);
}
...
libxml_xmlAddIDSafe(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Oz:xmlAddIDSafe", &pyobj_attr, &value))
        return(NULL);
...
libxml_xmlAddNextSibling(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OO:xmlAddNextSibling", &pyobj_prev, &pyobj_cur))
        return(NULL);
    prev = (xmlNodePtr) PyxmlNode_Get(pyobj_prev);
    cur = (xmlNodePtr) PyxmlNode_Get(pyobj_cur);

    c_retval = xmlAddNextSibling(prev, cur);
    py_retval = libxml_xmlNodePtrWrap((xmlNodePtr) c_retval);
    return(py_retval);
}
...
libxml_xmlAddPrevSibling(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OO:xmlAddPrevSibling", &pyobj_next, &pyobj_cur))
        return(NULL);
    next = (xmlNodePtr) PyxmlNode_Get(pyobj_next);
    cur = (xmlNodePtr) PyxmlNode_Get(pyobj_cur);

    c_retval = xmlAddPrevSibling(next, cur);
    py_retval = libxml_xmlNodePtrWrap((xmlNodePtr) c_retval);
    return(py_retval);
}
...
libxml_xmlAddSibling(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OO:xmlAddSibling", &pyobj_node, &pyobj_cur))
        return(NULL);
    node = (xmlNodePtr) PyxmlNode_Get(pyobj_node);
    cur = (xmlNodePtr) PyxmlNode_Get(pyobj_cur);

    c_retval = xmlAddSibling(node, cur);
    py_retval = libxml_xmlNodePtrWrap((xmlNodePtr) c_retval);
    return(py_retval);
}
...
libxml_xmlCtxtErrMemory(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtErrMemory", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtGetDeclaredEncoding(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtGetDeclaredEncoding", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtGetDocument(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtGetDocument", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtGetOptions(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtGetOptions", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtGetStandalone(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtGetStandalone", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtGetValidCtxt(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtGetValidCtxt", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtGetVersion(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtGetVersion", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtIsHtml(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtIsHtml", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtIsStopped(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlCtxtIsStopped", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtSetOptions(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Oi:xmlCtxtSetOptions", &pyobj_ctxt, &options))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlCtxtValidateDocument(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OO:xmlCtxtValidateDocument", &pyobj_ctxt, &pyobj_doc))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
    doc = (xmlDocPtr) PyxmlNode_Get(pyobj_doc);
...
libxml_xmlCtxtValidateDtd(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OOO:xmlCtxtValidateDtd", &pyobj_ctxt, &pyobj_doc, &pyobj_dtd))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
    doc = (xmlDocPtr) PyxmlNode_Get(pyobj_doc);
    dtd = (xmlDtdPtr) PyxmlNode_Get(pyobj_dtd);
...
libxml_xmlIOHTTPMatch(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("xmlIOHTTPMatch") == -1)
        return(NULL);
...
libxml_xmlNanoHTTPCleanup(PyObject *self ATTRIBUTE_UNUSED, PyObject *args ATTRIBUTE_UNUSED) {
    ...
    if (libxml_deprecationWarning("xmlNanoHTTPCleanup") == -1)
        return(NULL);
...
libxml_xmlNanoHTTPInit(PyObject *self ATTRIBUTE_UNUSED, PyObject *args ATTRIBUTE_UNUSED) {
    ...
    if (libxml_deprecationWarning("xmlNanoHTTPInit") == -1)
        return(NULL);
...
libxml_xmlNanoHTTPScanProxy(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("xmlNanoHTTPScanProxy") == -1)
        return(NULL);
...
libxml_xmlOutputBufferWrite(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Oiz:xmlOutputBufferWrite", &pyobj_out, &len, &data))
        return(NULL);
    out = (xmlOutputBufferPtr) PyoutputBuffer_Get(pyobj_out);

    c_retval = xmlOutputBufferWrite(out, len, data);
    py_retval = libxml_intWrap((int) c_retval);
    return(py_retval);
}
...
libxml_xmlRegisterHTTPPostCallbacks(PyObject *self ATTRIBUTE_UNUSED, PyObject *args ATTRIBUTE_UNUSED) {
    ...
    if (libxml_deprecationWarning("xmlRegisterHTTPPostCallbacks") == -1)
        return(NULL);
...
libxml_xmlSwitchEncodingName(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Oz:xmlSwitchEncodingName", &pyobj_ctxt, &encoding))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);
...
libxml_xmlTextReaderGetLastError(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlTextReaderGetLastError", &pyobj_reader))
        return(NULL);
    reader = (xmlTextReaderPtr) PyxmlTextReader_Get(pyobj_reader);
...
libxml_xmlValidateDocument(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OO:xmlValidateDocument", &pyobj_vctxt, &pyobj_doc))
        return(NULL);
    vctxt = (xmlValidCtxtPtr) PyValidCtxt_Get(pyobj_vctxt);
    doc = (xmlDocPtr) PyxmlNode_Get(pyobj_doc);

    c_retval = xmlValidateDocument(vctxt, doc);
    py_retval = libxml_intWrap((int) c_retval);
    return(py_retval);
}
...
libxml_xmlXPathErr(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Oi:xmlXPathErr", &pyobj_ctxt, &code))
        return(NULL);
    ctxt = (xmlXPathParserContextPtr) PyxmlXPathParserContext_Get(pyobj_ctxt);
...
libxml_xmlXPathValuePop(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlXPathValuePop", &pyobj_ctxt))
        return(NULL);
    ctxt = (xmlXPathParserContextPtr) PyxmlXPathParserContext_Get(pyobj_ctxt);
